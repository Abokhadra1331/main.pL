...
# قراءة التوكن بأمان من إعدادات Hugging Face (Secrets)
...
# ---- كود ويب مدمج مخصص لإبقاء السيرفر حياً على Hugging Face ----
...
def run_web_server():
    # المنصة تمرر المنفذ تلقائياً عبر متغير بيئة يسمى PORT وافتراضياً يكون 7860
...
def main():
    ...
    # 1. تشغيل سيرفر ويب Flask في خلفية منفصلة لتجنب إيقاف الاستضافة
    threading.Thread(target=run_web_server, daemon=True).start()
    print("✅ سيرفر الويب المساعد بدأ العمل...")
    ...
    print("✅ بوت تليجرام بدأ العمل بالكامل...")
    app.run_polling()
